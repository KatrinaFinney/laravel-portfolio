...
const HomepageHeading = ({ mobile }) => (
    <Container text>
        ...
        <Image
            avatar
            src="/Users/katrinafinney/katrina-portfolio/resources/assets/images/katrina.png"
        />
    </Container>
);
                ...
                <Grid.Row>
                    <Grid.Column width={8}>
                        ...
                        <p style={{ fontSize: "1.33em" }}>
                            My passion is learning new programming languages,
                            and building amazing things with them.
                        </p>
                        <Header as="h3" style={{ fontSize: "2em" }}>
            ...
            <Grid celled="internally" columns="equal" stackable>
                <Grid.Row textAlign="center">
                    ...
                    >
                        ...
                        <p style={{ fontSize: "1.33em" }}>
                            "Laborum qui duis officia dolore fugiat esse dolore
                            sunt sint irure pariatur."
                        </p>
                    </Grid.Column>
                    <Grid.Column
                        style={{ paddingBottom: "5em", paddingTop: "5em" }}
